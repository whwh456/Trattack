...
logzero.logfile(os.path.join(os.environ['HOMEPATH'], 'log.txt'), backupCount=3)
...
def joint_train(args, model, train_loader, test_loader, train_sampler=None, device=None):
    ...
    # TODO
    alpha, beta, gamma = [0, 1, 0] if args.training_strategy == 'no_pre_joint_training' else [1, 10, 1]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training-strategy', type=str, default='only_joint_training',
